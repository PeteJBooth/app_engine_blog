...
CSP_STYLE_SRC = ("'self'", "fonts.googleapis.com", "*.gstatic.com", "'unsafe-inline'", "maxcdn.bootstrapcdn.com")#TODO: remove this once styles are fixed
...
CSP_SCRIPT_SRC = ("'self' 'unsafe-eval' 'unsafe-inline'", "*.googleanalytics.com", "*.google-analytics.com", "ajax.googleapis.com", "maxcdn.bootstrapcdn.com")
